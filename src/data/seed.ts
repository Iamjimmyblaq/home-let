...
export const hotels: Hotel[] = [
  { id: 'h1', name: 'The Lagoon Suites', location: 'Victoria Island', city: 'Lagos', pricePerNight: 75_000, rating: 4.6, image: img('1566073771259-6a8506099945'), amenities: ['Pool', 'Spa', 'Gym', 'Restaurant'] },
  { id: 'h2', name: 'Aso Rock Boutique', location: 'Maitama', city: 'Abuja', pricePerNight: 62_000, rating: 4.4, image: img('1542314831-068cd1dbfeeb'), amenities: ['Wi-Fi', 'Breakfast', 'Bar'] },
  { id: 'h3', name: 'Ocean Pearl Resort', location: 'Ibeju-Lekki', city: 'Lagos', pricePerNight: 145_000, rating: 4.8, image: img('1571003123894-1f0594d2b5d9'), amenities: ['Beach', 'Pool', 'Spa', 'Bar'] },
  { id: 'h4', name: 'Garden City Inn', location: 'GRA', city: 'Port Harcourt', pricePerNight: 38_000, rating: 4.1, image: img('1551882547-ff40c63fe5fa'), amenities: ['Wi-Fi', 'Parking', 'Restaurant'] },
];
